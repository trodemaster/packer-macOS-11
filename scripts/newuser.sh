...
sysadminctl -addUser "$NEW_USERNAME" -fullName "Administrator" -password Password -home /Users/"$NEW_USERNAME" -admin -shell /bin/zsh -picture /Users/Shared/Adminicon.jpg
